...
public: // 静的メンバ関数 Static member function
	...
	static std::unique_ptr<PlayerBullet_R>Create(Model* model, Camera* camera, XMFLOAT3 pos, XMFLOAT3 rot, const XMVECTOR& velocity);
...
public: // メンバ関数 Member function
	...
	/// コンストラクタ Constructor
	/// </summary>
	PlayerBullet_R() = default;

	/// <summary>
	/// デストラクタ Destructor
	/// </summary>
	virtual ~PlayerBullet_R();
